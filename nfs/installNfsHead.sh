...
# Let the beegfs node have access to the shared directories.
beegfsip=$(($3 + 1))
echo "/home 192.168.1.$beegfsip(rw,sync,no_root_squash,no_subtree_check)" | sudo tee -a /etc/exports
echo "/mpishare 192.168.1.$beegfsip(rw,sync,no_root_squash,no_subtree_check)" | sudo tee -a /etc/exports
echo "/opt 192.168.1.$beegfsip(rw,sync,no_root_squash,no_subtree_check)" | sudo tee -a /etc/exports
echo "/software 192.168.1.$beegfsip(rw,sync,no_root_squash,no_subtree_check)" | sudo tee -a /etc/exports
